 ...
 */
            function(e) {
                var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, v, y, m, x, b = "sizzle" + 1 * new Date, w = e.document, T = 0, C = 0, S = eu(), E = eu(), k = eu(), A = eu(), N = function(e, t) {
                    return e === t && (f = !0),
                    0
                    ...
                    for (var n = 0, r = e.length; n < r; n++)
                        if (e[n] === t)
                            return n;
                    return -1
                }, R = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", I = "(?:\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\x00-\\x7f])+", W = "\\[" + M + "*(" + I + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + M + "*\\]", F = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + W + ")*)|.*)\\)|)", $ = RegExp(M + "+", "g"), B = RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"), _ = RegExp("^" + M + "*," + M + "*"), z = RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), U = RegExp(M + "|>"), X = RegExp(F), V = RegExp("^" + I + "$"), G = {
                    ID: RegExp("^#(" + I + ")"),
                    CLASS: RegExp("^\\.(" + I + ")"),
                    TAG: RegExp("^(" + I + "|[*])"),
                    ATTR: RegExp("^" + W),
                ...
                }, Y = /HTML$/i, Q = /^(?:input|select|textarea|button)$/i, J = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, et = RegExp("\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\([^\\r\\n\\f])", "g"), en = function(e, t) {
                    ...
                    g)) {
                        if (11 !== w && (f = Z.exec(e))) {
                            if (o = f[1]) {
                                ...
                                r;
                            else if ((o = f[3]) && n.getElementsByClassName && t.getElementsByClassName)
                        ...
                        if (n.qsa && !A[e + " "] && (!v || !v.test(e)) && (1 !== w || "object" !== t.nodeName.toLowerCase())) {
                            ...
                            1 === w && (U.test(e) || z.test(e))) {
                                for ((m = ee.test(e) && eg(t.parentNode) || t) === t && n.scope || ((c = t.getAttribute("id")) ? c = c.replace(er, ei) : t.setAttribute("id", c = b)),
                                s = (h = a(e)).length; s--; )
                                    h[s] = (c ? "#" + c : ":scope") + " " + ey(h[s]);
                                y = h.join(",")
                            }
                            try {
                ...
                function ed(e) {
                    return function(t) {
                        if ("form"in t)
                            return t.parentNode && !1 === t.disabled ? "label"in t ? "label"in t.parentNode ? t.parentNode.disabled === e : t.disabled === e : t.isDisabled === e || !e !== t.isDisabled && ea(t) === e : t.disabled === e;
                ...
                for (t in n = es.support = {},
                o = es.isXML = function(e) {
                    var t = e && e.namespaceURI
                      , n = e && (e.ownerDocument || e).documentElement;
                    return !Y.test(t || n && n.nodeName || "HTML")
                }
                ,
                p = es.setDocument = function(e) {
                    var t, i, a = e ? e.ownerDocument || e : w;
                    return a != d && 9 === a.nodeType && a.documentElement && (h = (d = a).documentElement,
                    g = !o(d),
                    w != d && (i = d.defaultView) && i.top !== i && (i.addEventListener ? i.addEventListener("unload", eo, !1) : i.attachEvent && i.attachEvent("onunload", eo)),
                    n.scope = ec(function(e) {
                        return h.appendChild(e).appendChild(d.createElement("div")),
                        void 0 !== e.querySelectorAll && !e.querySelectorAll(":scope fieldset div").length
                    }),
                    n.cssSupportsSelector = ec(function() {
                        return CSS.supports("selector(*)") && d.querySelectorAll(":is(:jqfake)") && !CSS.supports("selector(:is(*,:jqfake))")
                    }),
                    n.attributes = ec(function(e) {
                        return e.className = "i",
                        !e.getAttribute("className")
                    }),
                    n.getElementsByTagName = ec(function(e) {
                        return e.appendChild(d.createComment("")),
                        !e.getElementsByTagName("*").length
                    }),
                    n.getElementsByClassName = K.test(d.getElementsByClassName),
                    n.getById = ec(function(e) {
                    ...
                    y = [],
                    v = [],
                    (n.qsa = K.test(d.querySelectorAll)) && (ec(function(e) {
                        var t;
                    ...
                    (n.matchesSelector = K.test(m = h.matches || h.webkitMatchesSelector || h.mozMatchesSelector || h.oMatchesSelector || h.msMatchesSelector)) && ec(function(e) {
                    ...
                    x = (t = K.test(h.compareDocumentPosition)) || K.test(h.contains) ? function(e, t) {
                    ...
                    : function(e, t) {
                        ...
                        for (; a[r] === s[r]; )
                            r++;
                        return r ? ep(a[r], s[r]) : a[r] == w ? -1 : s[r] == w ? 1 : 0
                    }
                    ),
                    d
                }
                ,
                es.matches = function(e, t) {
                    return es(e, null, null, t)
                }
                ,
                es.matchesSelector = function(e, t) {
                    if (p(e),
                    ...
                    return es(t, d, null, [e]).length > 0
                }
                ,
                es.contains = function(e, t) {
                    return (e.ownerDocument || e) != d && p(e),
                    x(e, t)
                }
                ,
                es.attr = function(e, t) {
                ...
                (r = es.selectors = {
                    ...
                    preFilter: {
                        ...
                        CHILD: function(e) {
                            ...
                            "nth" === e[1].slice(0, 3) ? (e[3] || es.error(e[0]),
                            e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3])),
                            e[5] = +(e[7] + e[8] || "odd" === e[3])) : e[3] && es.error(e[0]),
                            e
                        },
                        PSEUDO: function(e) {
                            var t, n = !e[6] && e[2];
                    ...
                    filter: {
                        ...
                        PSEUDO: function(e, t) {
                            var n, i = r.pseudos[e] || r.setFilters[e.toLowerCase()] || es.error("unsupported pseudo: " + e);
                            return i[b] ? i(t) : i.length > 1 ? (n = [e, e, "", t],
                            r.setFilters.hasOwnProperty(e.toLowerCase()) ? el(function(e, n) {
                    ...
                    pseudos: {
                        not: el(function(e) {
                            var t = []
                              , n = []
                              , r = s(e.replace(B, "$1"));
                            return r[b] ? el(function(e, t, n, i) {
                        ...
                        lang: el(function(e) {
                            return V.test(e || "") || es.error("unsupported lang: " + e),
                        ...
                        last: eh(function(e, t) {
                            return [t - 1]
                        }),
                        eq: eh(function(e, t, n) {
                            return [n < 0 ? n + t : n]
                        }),
                        even: eh(function(e, t) {
                            for (var n = 0; n < t; n += 2)
                                e.push(n);
                            return e
                        }),
                        ...
                        lt: eh(function(e, t, n) {
                            for (var r = n < 0 ? n + t : n > t ? t : n; --r >= 0; )
                                e.push(r);
                            return e
                        }),
                        gt: eh(function(e, t, n) {
                ...
                return ev.prototype = r.filters = r.pseudos,
                r.setFilters = new ev,
                a = es.tokenize = function(e, t) {
                    ...
                    return t ? s.length : s ? es.error(e) : E(e, u).slice(0)
                }
                ,
                s = es.compile = function(e, t) {
                    var n, i, o, s, u = [], c = [], f = k[e + " "];
                    if (!f) {
                        for (t || (t = a(e)),
                        s = t.length; s--; )
                            (f = function e(t) {
                                for (var n, i, o, a = t.length, s = r.relative[t[0].type], u = s || r.relative[" "], c = s ? 1 : 0, f = em(function(e) {
                                    return e === n
                                }, u, !0), p = em(function(e) {
                                    return P(n, e) > -1
                                }, u, !0), d = [function(e, t, r) {
                                    var i = !s && (r || t !== l) || ((n = t).nodeType ? f(e, t, r) : p(e, t, r));
                                    return n = null,
                                    i
                                }
                                ]; c < a; c++)
                                    if (i = r.relative[t[c].type])
                                        d = [em(ex(d), i)];
                                    else {
                                        if ((i = r.filter[t[c].type].apply(null, t[c].matches))[b]) {
                                            for (o = ++c; o < a && !r.relative[t[o].type]; o++)
                                                ;
                                            return function e(t, n, r, i, o, a) {
                                                return i && !i[b] && (i = e(i)),
                                                o && !o[b] && (o = e(o, a)),
                                                el(function(e, a, s, u) {
                                                    var l, c, f, p = [], d = [], h = a.length, g = e || function(e, t, n) {
                                                        for (var r = 0, i = t.length; r < i; r++)
                                                            es(e, t[r], n);
                                                        return n
                                                    }(n || "*", s.nodeType ? [s] : s, []), v = t && (e || !n) ? eb(g, p, t, s, u) : g, y = r ? o || (e ? t : h || i) ? [] : a : v;
                                                    if (r && r(v, y, s, u),
                                                    i)
                                                        for (l = eb(y, d),
                                                        i(l, [], s, u),
                                                    ...
                                                    if (e) {
                                                        if (o || t) {
                                                            ...
                                                            for (c = y.length; c--; )
                                                                (f = y[c]) && (l = o ? P(e, f) : p[c]) > -1 && (e[l] = !(a[l] = f))
                                                        }
                                                    } else
                                                        y = eb(y === a ? y.splice(h, y.length) : y),
                                                        o ? o(null, a, y, u) : H.apply(a, y)
                                                })
                                            }(c > 1 && ex(d), c > 1 && ey(t.slice(0, c - 1).concat({
                                                value: " " === t[c - 2].type ? "*" : ""
                                            })).replace(B, "$1"), i, c < o && e(t.slice(c, o)), o < a && e(t = t.slice(o)), o < a && ey(t))
                                        }
                                        d.push(i)
                                    }
                                return ex(d)
                            }(t[s]))[b] ? u.push(f) : c.push(f);
                        (f = k(e, (n = u.length > 0,
                        i = c.length > 0,
                        o = function(e, t, o, a, s) {
                            var f, h, v, y = 0, m = "0", x = e && [], b = [], w = l, C = e || i && r.find.TAG("*", s), S = T += null == w ? 1 : Math.random() || .1, E = C.length;
                            for (s && (l = t == d || t || s); m !== E && null != (f = C[m]); m++) {
                                if (i && f) {
                                    for (h = 0,
                            ...
                            n && m !== y) {
                                ...
                                H.apply(a, b),
                                s && !e && b.length > 0 && y + u.length > 1 && es.uniqueSort(a)
                            }
                            return s && (T = S,
                            l = w),
                            x
                ...
                u = es.select = function(e, t, n, i) {
                    ...
                    1 === d.length) {
                        ...
                        !r.relative[c = l.type]); )
                            if ((f = r.find[c]) && (i = f(l.matches[0].replace(et, en), ee.test(u[0].type) && eg(t.parentNode) || t))) {
                                if (u.splice(o, 1),
                                !(e = i.length && ey(u)))
                                    return H.apply(n, i),
                                    n;
                    ...
                    return (p || s(e, d))(i, t, !g, n, !t || ee.test(e) && eg(t.parentNode) || t),
                    n
                }
                ,
            ...
            E.each({
                ...
                contents: function(e) {
                    return null != e.contentDocument && s(e.contentDocument) ? e.contentDocument : (q(e, "template") && (e = e.content || e),
                                    ...
                                    var s = this
                                      ...
                                      , l = function() {
                                        ...
                                        if (!(e < o)) {
                                            ...
                                            m(l = r && ("object" == typeof r || "function" == typeof r) && r.then) ? i ? l.call(r, a(o, t, F, i), a(o, t, $, i)) : (o++,
                                            l.call(r, a(o, t, F, i), a(o, t, $, i), a(o, t, F, t.notifyWith))) : (n !== F && (s = void 0,
                                            u = [r]),
                                            (i || t.resolveWith)(s, u))
                                        }
                                    }
            ...
            E.ready.then = z.then,
            "complete" !== b.readyState && ("loading" === b.readyState || b.documentElement.doScroll) ? (b.addEventListener("DOMContentLoaded", U),
            r.addEventListener("load", U)) : r.setTimeout(E.ready);
            ...
            K.prototype = {
                ...
                remove: function(e, t) {
                    ...
                    if (void 0 !== r) {
                        if (void 0 !== t)
                            for (n = (t = Array.isArray(t) ? t.map(Q) : ((t = Q(t))in r) ? [t] : t.match(W) || []).length; n--; )
                                delete r[t[n]];
            ...
            function er(e, t, n) {
                ...
                if (void 0 === n && 1 === e.nodeType) {
                    if (r = "data-" + t.replace(en, "-$&").toLowerCase(),
                    "string" == typeof (n = e.getAttribute(r))) {
                        try {
                            i = n,
                            n = "true" === i || "false" !== i && ("null" === i ? null : i === +i + "" ? +i : et.test(i) ? JSON.parse(i) : i)
                        } catch (e) {}
                        ee.set(e, t, n)
                    } else
                        n = void 0
                ...
                data: function(e, t) {
                    ...
                    if (void 0 === e) {
                        ...
                        1 === o.nodeType && !Z.get(o, "hasDataAttrs"))) {
                            for (n = a.length; n--; )
                                a[n] && 0 === (r = a[n].name).indexOf("data-") && er(o, r = Q(r.slice(5)), i[r]);
                    ...
                    return "object" == typeof e ? this.each(function() {
                        ...
                        var n;
                        if (o && void 0 === t)
                            return void 0 !== (n = ee.get(o, e)) || void 0 !== (n = er(o, e)) ? n : void 0;
                        this.each(function() {
                            ee.set(this, e, t)
                        })
            ...
            es.getRootNode && (eu = function(e) {
                return E.contains(e.ownerDocument, e) || e.getRootNode(el) === e.ownerDocument
            }
            );
            var ec = function(e, t) {
                return "none" === (e = t || e).style.display || "" === e.style.display && eu(e) && "none" === E.css(e, "display")
            };
            function ef(e, t, n, r) {
                ...
                , u = s(), l = n && n[3] || (E.cssNumber[t] ? "" : "px"), c = e.nodeType && (E.cssNumber[t] || "px" !== l && +u) && eo.exec(E.css(e, t));
                if (c && c[3] !== l) {
                    for (u /= 2,
                    l = l || c[3],
                    c = +u || 1; a--; )
            ...
            function ed(e, t) {
                for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
                    ...
                    i[o] || (r.style.display = "")),
                    "" === r.style.display && ec(r) && (i[o] = function(e) {
                        var t, n = e.ownerDocument, r = e.nodeName, i = ep[r];
            ...
            function em(e, t) {
                ...
                void 0 === t || t && q(e, t)) ? E.merge([e], n) : n
            }
            function ex(e, t) {
                for (var n = 0, r = e.length; n < r; n++)
            ...
            ey.th = ey.td,
            y.option || (ey.optgroup = ey.option = [1, "<select multiple='multiple'>", "</select>"]);
            var eb = /<|&#?\w+;/;
                ...
                for (var o, a, s, u, l, c = t.createDocumentFragment(), f = [], p = 0, d = e.length; p < d; p++)
                    if ((o = e[p]) || 0 === o) {
                        if ("object" === C(o))
                            ...
                            s = ey[(eg.exec(o) || ["", ""])[1].toLowerCase()] || ey._default,
            ...
            E.event = {
                ...
                dispatch: function(e) {
                    var t, n, r, i, o, a, s = Array(arguments.length), u = E.event.fix(e), l = (Z.get(this, "events") || Object.create(null))[u.type] || [], c = E.event.special[u.type] || {};
                    for (t = 1,
                ...
                special: {
                    ...
                    click: {
                        setup: function(e) {
                            var t = this || e;
                            return eh.test(t.type) && t.click && q(t, "input") && eA(t, "click", eC),
                            !1
                        },
                        trigger: function(e) {
                            var t = this || e;
                            return eh.test(t.type) && t.click && q(t, "input") && eA(t, "click"),
                            !0
                        },
                        _default: function(e) {
                            var t = e.target;
                            return eh.test(t.type) && t.click && q(t, "input") && Z.get(t, "click") || q(t, "a")
                        }
                    },
                    beforeunload: {
            ...
            E.Event = function(e, t) {
                ...
                this.type = e.type,
                this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? eC : eS,
            ...
            function eP(e, t, n, r) {
                ...
                if (g || p > 1 && "string" == typeof h && !y.checkClone && ej.test(h))
                    return e.each(function(i) {
                        var o = e.eq(i);
                        g && (t[0] = h.call(this, i, o.html())),
                        eP(o, t, n, r)
                    });
                if (p && (o = (i = ew(t, e[0].ownerDocument, !1, e, r)).firstChild,
                ...
                o || r)) {
                    ...
                    if (s)
                        ...
                        f = 0; f < s; f++)
                            u = a[f],
                            ev.test(u.type || "") && !Z.access(u, "globalEval") && E.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? E._evalUrl && !u.noModule && E._evalUrl(u.src, {
                                nonce: u.nonce || u.getAttribute("nonce")
                            }, c) : T(u.textContent.replace(eD, ""), u, c))
                }
                return e
            }
            function eR(e, t, n) {
                for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
                    ...
                    r.parentNode && (n && eu(r) && ex(em(r, "script")),
            ...
            E.extend({
                ...
                clone: function(e, t, n) {
                    var r, i, o, a, s = e.cloneNode(!0), u = eu(e);
                    if (!y.noCloneChecked && (1 === e.nodeType || 11 === e.nodeType) && !E.isXMLDoc(e))
                        for (r = 0,
                        a = em(s),
                        i = (o = em(e)).length; r < i; r++)
                            !function(e, t) {
                                var n = t.nodeName.toLowerCase();
                                "input" === n && eh.test(e.type) ? t.checked = e.checked : ("input" === n || "textarea" === n) && (t.defaultValue = e.defaultValue)
                            }(o[r], a[r]);
                    if (t) {
                        if (n)
                            for (r = 0,
                    ...
                    return (a = em(s, "script")).length > 0 && ex(a, !u && em(e, "script")),
                    s
                },
            ...
            E.fn.extend({
                ...
                append: function() {
                    return eP(this, arguments, function(e) {
                        (1 === this.nodeType || 11 === this.nodeType || 9 === this.nodeType) && eq(this, e).appendChild(e)
                    })
                },
                prepend: function() {
                    return eP(this, arguments, function(e) {
                ...
                empty: function() {
                    for (var e, t = 0; null != (e = this[t]); t++)
                        1 === e.nodeType && (E.cleanData(em(e, !1)),
                        e.textContent = "");
                    return this
                },
                clone: function(e, t) {
                ...
                html: function(e) {
                    return X(this, function(e) {
                        ...
                        if (void 0 === e && 1 === t.nodeType)
                            return t.innerHTML;
                        if ("string" == typeof e && !eN.test(e) && !ey[(eg.exec(e) || ["", ""])[1].toLowerCase()]) {
                            e = E.htmlPrefilter(e);
                            try {
                                for (; n < r; n++)
                                    t = this[n] || {},
                                    1 === t.nodeType && (E.cleanData(em(t, !1)),
                                    t.innerHTML = e);
                                t = 0
                            } catch (e) {}
                        }
                ...
                replaceWith: function() {
                    ...
                    return eP(this, arguments, function(t) {
                        ...
                        0 > E.inArray(this, e) && (E.cleanData(em(this)),
            ...
            var eM = RegExp("^(" + ei + ")(?!px)[a-z%]+$", "i")
              ...
              , e_ = RegExp("^" + eB + "+|((?:^|[^\\\\])(?:\\\\.)*)" + eB + "+$", "g");
            function ez(e, t, n) {
                var r, i, o, a, s = eI.test(t), u = e.style;
                return (n = n || eW(e)) && (a = n.getPropertyValue(t) || n[t],
                s && a && (a = a.replace(e_, "$1") || void 0),
                "" !== a || eu(e) || (a = E.style(e, t)),
                !y.pixelBoxStyles() && eM.test(a) && e$.test(t) && (r = u.width,
                i = u.minWidth,
                o = u.maxWidth,
            ...
            var eX = ["Webkit", "Moz", "ms"]
              ...
              , eG = {};
            function eY(e) {
                return E.cssProps[e] || eG[e] || (e in eV ? e : eG[e] = function(e) {
            ...
            function e0(e, t, n, r, i, o) {
                ...
                for (; a < 4; a += 2)
                    ...
                    r ? ("content" === n && (u -= E.css(e, "padding" + ea[a], !0, i)),
                    "margin" !== n && (u -= E.css(e, "border" + ea[a] + "Width", !0, i))) : (u += E.css(e, "padding" + ea[a], !0, i),
                    "padding" !== n ? u += E.css(e, "border" + ea[a] + "Width", !0, i) : s += E.css(e, "border" + ea[a] + "Width", !0, i));
            ...
            function e1(e, t, n) {
                ...
                return (!y.boxSizingReliable() && i || !y.reliableTrDimensions() && q(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === E.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === E.css(e, "boxSizing", !1, r),
                (o = s in e) && (a = e[s])),
                (a = parseFloat(a) || 0) + e0(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
            }
            ...
            E.extend({
                ...
                style: function(e, t, n, r) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var i, o, a, s = Q(t), u = eI.test(t), l = e.style;
                        if (u || (t = eY(s)),
                        a = E.cssHooks[t] || E.cssHooks[s],
                        void 0 === n)
                            return a && "get"in a && void 0 !== (i = a.get(e, !1, r)) ? i : l[t];
                        "string" == (o = typeof n) && (i = eo.exec(n)) && i[1] && (n = ef(e, t, i),
                        o = "number"),
            ...
            E.each(["height", "width"], function(e, t) {
                E.cssHooks[t] = {
                    get: function(e, n, r) {
                        if (n)
                            return !eQ.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? e1(e, t, r) : eF(e, eJ, function() {
                                return e1(e, t, r)
                            })
                    },
                    set: function(e, n, r) {
                        var i, o = eW(e), a = !y.scrollboxSize() && "absolute" === o.position, s = (a || r) && "border-box" === E.css(e, "boxSizing", !1, o), u = r ? e0(e, t, r, s, o) : 0;
                        return s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - e0(e, t, "border", !1, o) - .5)),
                        u && (i = eo.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                        n = E.css(e, t)),
                        eZ(e, n, u)
                    }
                }
            ...
            E.cssHooks.marginLeft = eU(y.reliableMarginLeft, function(e, t) {
                if (t)
                    return (parseFloat(ez(e, "marginLeft")) || e.getBoundingClientRect().left - eF(e, {
                        marginLeft: 0
                    }, function() {
            ...
            e2.propHooks = {
                _default: {
                    ...
                    set: function(e) {
                        E.fx.step[e.prop] ? E.fx.step[e.prop](e) : 1 === e.elem.nodeType && (E.cssHooks[e.prop] || null != e.elem.style[eY(e.prop)]) ? E.style(e.elem, e.prop, e.now + e.unit) : e.elem[e.prop] = e.now
                    }
                }
            },
            ...
            E.fx.step = {};
            var e3, e5, e4, e6, e9 = /^(?:toggle|show|hide)$/, e7 = /queueHooks$/;
            function e8() {
            ...
            function tt(e, t, n) {
                for (var r, i = (tn.tweeners[t] || []).concat(tn.tweeners["*"]), o = 0, a = i.length; o < a; o++)
                    if (r = i[o].call(n, t, e))
                        return r
            }
            function tn(e, t, n) {
                var r, i, o = 0, a = tn.prefilters.length, s = E.Deferred().always(function() {
                    delete u.elem
                }), u = function() {
                    if (i)
                        return !1;
                    for (var t = e4 || e8(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length; o < a; o++)
                        l.tweens[o].run(r);
                ...
                for (function(e, t) {
                    ...
                    if (r = tn.prefilters[o].call(l, e, c, l.opts))
                        return m(r.stop) && (E._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)),
                        r;
                return E.map(c, tt, l),
            ...
            E.Animation = E.extend(tn, {
                tweeners: {
                    "*": [function(e, t) {
                        ...
                        return ef(n.elem, e, eo.exec(t), n),
                        n
                    }
                    ]
                },
                ...
                prefilters: [function(e, t, n) {
                    var r, i, o, a, s, u, l, c, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && ec(e), v = Z.get(e, "fxshow");
                    ...
                    if (!(!(u = !E.isEmptyObject(t)) && E.isEmptyObject(d)))
                        ...
                        "none" === (c = E.css(e, "display")) && (l ? c = l : (ed([e], !0),
                        l = e.style.display || l,
                        c = E.css(e, "display"),
                        ed([e]))),
            ...
            E.fn.extend({
                fadeTo: function(e, t, n, r) {
                    return this.filter(ec).css("opacity", 0).show().end().animate({
                        opacity: t
                    }, e, n, r)
                },
            ...
            E.fx.start = function() {
                e6 || (e6 = !0,
                function e() {
                    e6 && (!1 === b.hidden && r.requestAnimationFrame ? r.requestAnimationFrame(e) : r.setTimeout(e, E.fx.interval),
                    E.fx.tick())
                }())
            }
            ,
            ...
            ti = b.createElement("select").appendChild(b.createElement("option")),
            tr.type = "checkbox",
            y.checkOn = "" !== tr.value,
            ...
            var tr, ti, to, ta = E.expr.attrHandle;
            E.fn.extend({
                attr: function(e, t) {
                ...
                attr: function(e, t, n) {
                    ...
                    if (3 !== o && 8 !== o && 2 !== o) {
                        if (void 0 === e.getAttribute)
                            return E.prop(e, t, n);
                        if (1 === o && E.isXMLDoc(e) || (i = E.attrHooks[t.toLowerCase()] || (E.expr.match.bool.test(t) ? to : void 0)),
                        void 0 !== n) {
                            if (null === n) {
                                E.removeAttr(e, t);
                                return
                            }
                            return i && "set"in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""),
                            n)
                        }
                        return i && "get"in i && null !== (r = i.get(e, t)) ? r : null == (r = E.find.attr(e, t)) ? void 0 : r
                    }
                },
                attrHooks: {
                    type: {
            ...
            E.fn.extend({
                ...
                toggleClass: function(e, t) {
                    ...
                    }) : "boolean" == typeof t && s ? t ? this.addClass(e) : this.removeClass(e) : (n = tf(e),
                    this.each(function() {
                        if (s)
                            for (i = 0,
                            o = E(this); i < n.length; i++)
                                r = n[i],
                                o.hasClass(r) ? o.removeClass(r) : o.addClass(r);
                        else
                            (void 0 === e || "boolean" === a) && ((r = tc(this)) && Z.set(this, "__className__", r),
                ...
                hasClass: function(e) {
                    var t, n, r = 0;
                    for (t = " " + e + " "; n = this[r++]; )
                        if (1 === n.nodeType && (" " + tl(tc(n)) + " ").indexOf(t) > -1)
                            return !0;
                    return !1
                }
            });
            ...
            E.fn.extend({
                val: function(e) {
                    ...
                    })) : i ? (t = E.valHooks[i.type] || E.valHooks[i.nodeName.toLowerCase()]) && "get"in t && void 0 !== (n = t.get(i, "value")) ? n : "string" == typeof (n = i.value) ? n.replace(tp, "") : null == n ? "" : n : void 0
                }
            }),
            E.extend({
                valHooks: {
            ...
            E.extend(E.event, {
                trigger: function(e, t, n, i) {
                    ...
                    if (a = p = s = n = n || b,
                    !(3 === n.nodeType || 8 === n.nodeType || td.test(g + E.event.triggered)) && (g.indexOf(".") > -1 && (g = (v = g.split(".")).shift(),
                    v.sort()),
                    l = 0 > g.indexOf(":") && "on" + g,
                    ...
                    i || !f.trigger || !1 !== f.trigger.apply(n, t))) {
                        if (!i && !f.noBubble && !x(n)) {
                            ...
                            td.test(u + g) || (a = a.parentNode); a; a = a.parentNode)
                                d.push(a),
                                s = a;
                        ...
                        return e.type = g,
                        !i && !e.isDefaultPrevented() && (!f._default || !1 === f._default.apply(d.pop(), t)) && J(n) && l && m(n[g]) && !x(n) && ((s = n[l]) && (n[l] = null),
                        E.event.triggered = g,
            ...
            E.fn.extend({
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var e = this.type;
                        return this.name && !E(this).is(":disabled") && tw.test(this.nodeName) && !tb.test(e) && (this.checked || !eh.test(e))
                    }).map(function(e, t) {
                        var n = E(this).val();
            ...
            E.extend({
                ...
                ajax: function(e, t) {
                    ...
                    e = void 0),
                    t = t || {};
                    var n, i, o, a, s, u, l, c, f, p, d = E.ajaxSetup({}, t), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? E(h) : E.event, v = E.Deferred(), y = E.Callbacks("once memory"), m = d.statusCode || {}, x = {}, w = {}, T = "canceled", C = {
                        readyState: 0,
                        ...
                        setRequestHeader: function(e, t) {
                            return null == l && (x[e = w[e.toLowerCase()] = w[e.toLowerCase()] || e] = t),
                            this
                        },
                    ...
                    if (v.promise(C),
                    d.url = ((e || d.url || tg.href) + "").replace(tA, tg.protocol + "//"),
                    ...
                    null == d.crossDomain) {
                        ...
                        try {
                            u.href = d.url,
                            u.href = u.href,
                            d.crossDomain = tq.protocol + "//" + tq.host != u.protocol + "//" + u.host
                        } catch (e) {
                            d.crossDomain = !0
                        }
                    }
                    ...
                    i = d.url.replace(tC, ""),
                    d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(tT, "+")) : (p = d.url.slice(i.length),
                    ...
                    C.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + tD + "; q=0.01" : "") : d.accepts["*"]),
                    d.headers)
                    ...
                    function S(e, t, a, u) {
                        ...
                        !f && E.inArray("script", d.dataTypes) > -1 && 0 > E.inArray("json", d.dataTypes) && (d.converters["text script"] = function() {}
                        ),
                        b = function(e, t, n, r) {
                        ...
                        send: function(i, o) {
                            ...
                            t = function(e) {
                                return function() {
                                    ...
                                    "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(tP[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                        binary: s.response
                                    } : {
                                        text: s.responseText
            ...
            E.ajaxPrefilter("json jsonp", function(e, t, n) {
                var i, o, a, s = !1 !== e.jsonp && (tI.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && tI.test(e.data) && "data");
                if (s || "jsonp" === e.dataTypes[0])
                    return i = e.jsonpCallback = m(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
                    s ? e[s] = e[s].replace(tI, "$1" + i) : !1 !== e.jsonp && (e.url += (ty.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
            ...
            y.createHTMLDocument = ((o = b.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
            ...
            E.parseHTML = function(e, t, n) {
                ...
                i = L.exec(e),
                o = !n && [],
                i) ? [t.createElement(i[1])] : (i = ew([e], t, o),
