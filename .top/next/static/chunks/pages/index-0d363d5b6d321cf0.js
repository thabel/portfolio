    ...
    7190: function(s, e, a) {
                    ...
                    i.jsx)(c(), {
                        ...
                        i.jsxs)("a", {
                            ...
                            i.jsx)("span", {
                                ...
                                children: (0,
                                i.jsx)("img", {
                                    src: "assets/blog/blog-post-1.jpg",
                                    alt: ""
                                })
                            }), (0,
                            i.jsxs)("div", {
                                ...
                                i.jsx)("p", {
                                    children: "ncididunt ut labore et dolore magna aliqua. Ut enim aminim veniam..."
                                }), (0,
                                i.jsxs)("div", {
                    ...
                    i.jsx)(c(), {
                        ...
                        i.jsxs)("a", {
                            ...
                            i.jsx)("span", {
                                ...
                                children: (0,
                                i.jsx)("img", {
                                    src: "assets/blog/blog-post-2.jpg",
                                    alt: ""
                                })
                            }), (0,
                            i.jsxs)("div", {
                                ...
                                i.jsx)("span", {
                                    className: "title",
                                    children: "How Efficient Site Structure Can Boost SEO"
                                }), (0,
                                i.jsx)("p", {
                                    children: "ncididunt ut labore et dolore magna aliqua. Ut enim aminim veniam..."
                                }), (0,
                    ...
                    i.jsx)(c(), {
                        ...
                        i.jsxs)("a", {
                            ...
                            i.jsx)("span", {
                                ...
                                children: (0,
                                i.jsx)("img", {
                                    src: "assets/blog/blog-post-3.jpg",
                                    alt: ""
                                })
                            }), (0,
                            i.jsxs)("div", {
                                ...
                                i.jsx)("span", {
                                    className: "title",
                                    children: "Change Management for Customer Success"
                                }), (0,
                                i.jsx)("p", {
                                    children: "ncididunt ut labore et dolore magna aliqua. Ut enim aminim veniam..."
                                }), (0,
        ...
        i.jsxs)("section", {
            ...
            i.jsxs)("div", {
                children: [(0,
                i.jsxs)("span", {
                    children: ["\xa9 ", new Date().getFullYear(), " Steven Walker"]
                }), (0,
                i.jsxs)("span", {
                    ...
                    i.jsxs)("h1", {
                        ...
                        i.jsxs)("span", {
                            ...
                            i.jsx)("span", {
                                ...
                                children: "Front-end Developer with 7 years experience based in London"
                            })]
                        }), (0,
                        i.jsx)("span", {
                            children: (0,
                ...
                i.jsx)("div", {
                    ...
                    i.jsxs)("div", {
                        ...
                        i.jsxs)("p", {
                            ...
                            i.jsx)("span", {
                                className: "quote",
                                children: '" I worked with Steven, he was very helpful and fast to respond to my inquiry to help with Wordpress website issues and all technical problems. "'
                            }), (0,
                            i.jsx)("span", {
                                className: "person",
        ...
        let y = () => {
            b()(window).on("load", function() {
                ...
                b()(window).width() > 1024 ? (setTimeout(function() {
                    b()(".header-inner").addClass("animated fadeInDown")
                }, 1500),
                setTimeout(function() {
                    b()(".home>div>div h1 span span").addClass("animated fadeInUp"),
                ...
                var e = b()(".home").width() - 10
                  ...
                  , n = i + b()(".portfolio .single-item .main-content").width() + b()(".portfolio .single-item .details").width() + 250 + 65 + 300 + b()(".clients").width() - 10
                  , l = n + b()(".contact").width() + b()(".testimonials").width() - 10
                  , r = l + b()(".blog").width() + b()(".copyright").width() - 10;
                b()("#wrapper").length && (b()(window).width() > 1024 ? b()("#wrapper").mCustomScrollbar({
                    axis: "x",
                    theme: "dark-3",
                    keyboard: {
                        enable: !0,
                    ...
                    callbacks: {
                        whileScrolling: function() {
                            ...
                            b()(".animated-layer").each(function() {
                                var e = b()(this);
                                b()(this).offset().left < s && (e.hasClass("image-animation") ? e.addClass("animated") : e.hasClass("fade-in-up-animation") ? e.addClass("animated fadeInUp") : e.hasClass("fade-in-animation") ? e.addClass("animated fadeIn") : e.hasClass("fade-in-down-animation") ? e.addClass("animated fadeInDown") : e.hasClass("fade-in-right-animation") ? e.addClass("animated fadeInRight") : e.hasClass("fade-in-left-animation") && e.addClass("animated fadeInLeft"))
                            }),
                            Math.abs(parseInt(b()(".mCSB_container").css("left"))) > e && Math.abs(parseInt(b()(".mCSB_container").css("left"))) < i ? (b()(".menu ul li span").removeClass("active"),
                            b()("#about-link").addClass("active")) : Math.abs(parseInt(b()(".mCSB_container").css("left"))) > i && Math.abs(parseInt(b()(".mCSB_container").css("left"))) < n ? (b()(".menu ul li span").removeClass("active"),
                            b()("#portfolio-link").addClass("active")) : Math.abs(parseInt(b()(".mCSB_container").css("left"))) > n && Math.abs(parseInt(b()(".mCSB_container").css("left"))) < l ? (b()(".menu ul li span").removeClass("active"),
                            b()("#contact-link").addClass("active")) : Math.abs(parseInt(b()(".mCSB_container").css("left"))) > l && Math.abs(parseInt(b()(".mCSB_container").css("left"))) < r ? (b()(".menu ul li span").removeClass("active"),
                            b()("#blog-link").addClass("active")) : (b()(".menu ul li span").removeClass("active"),
            ...
            b()(document).ready(function() {
                ...
                b()(window).width() > 1024 && (b()(".fadeIn").removeClass("fadeIn"),
                ...
                b()("#cta").on("click", function() {
                    b()(window).width() > 1024 ? b()("#wrapper").mCustomScrollbar("scrollTo", "#about", {
                        scrollInertia: 1500
                    }) : b()("html, body").animate({
